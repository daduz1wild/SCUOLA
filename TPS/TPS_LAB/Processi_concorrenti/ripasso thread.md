user thread=thread riferiti all'applicazione scrita dsll'applicazione(applicativo creato dal programmatore). non sono vincolati dalla java virtual machine, priorita piu alta
